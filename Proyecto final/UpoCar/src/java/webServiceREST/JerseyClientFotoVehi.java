...
/**
 * Jersey REST client generated for REST resource:FotoVehiFacadeREST
 * [ws.fotovehi]<br>
 * USAGE:
 * <pre>
 *        JerseyClientFotoVehi client = new JerseyClientFotoVehi();
 ...
 */
public class JerseyClientFotoVehi {

    private WebTarget webTarget;
    private Client client;
    private static final String BASE_URI = "http://localhost:8080/WebService/webresources";

    public JerseyClientFotoVehi() {
        client = javax.ws.rs.client.ClientBuilder.newClient();
        webTarget = client.target(BASE_URI).path("ws.fotovehi");
    }
