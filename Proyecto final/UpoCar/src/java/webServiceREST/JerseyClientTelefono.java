...
/**
 * Jersey REST client generated for REST resource:TelefonoFacadeREST
 * [ws.telefono]<br>
 * USAGE:
 * <pre>
 *        JerseyClientTelefono client = new JerseyClientTelefono();
 ...
 * @author berse
 */
public class JerseyClientTelefono {

    private WebTarget webTarget;
    private Client client;
    private static final String BASE_URI = "http://localhost:8080/WebService/webresources";

    public JerseyClientTelefono() {
        client = javax.ws.rs.client.ClientBuilder.newClient();
        webTarget = client.target(BASE_URI).path("ws.telefono");
    }
