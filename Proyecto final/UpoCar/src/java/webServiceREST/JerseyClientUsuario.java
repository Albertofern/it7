 ...
 * USAGE:
 * <pre>
 *        JerseyClientUsuario client = new JerseyClientUsuario();
...
public class JerseyClientUsuario {
    ...
    public <T> T buscarUsuario(GenericType<T> responseType, String nomUsuario) throws ClientErrorException {
        WebTarget resource = webTarget;
        resource = resource.path(java.text.MessageFormat.format("buscarUsuario/{0}", new Object[]{nomUsuario}));
        return resource.request(javax.ws.rs.core.MediaType.APPLICATION_XML).get(responseType);
    }
    ...
    public <T> T login(GenericType<T> responseType, String nomUsuario, String password) throws ClientErrorException {
        WebTarget resource = webTarget;
        resource = resource.path(java.text.MessageFormat.format("login/{0}/{1}", new Object[]{nomUsuario, password}));
        return resource.request(javax.ws.rs.core.MediaType.APPLICATION_XML).get(responseType);
    }
