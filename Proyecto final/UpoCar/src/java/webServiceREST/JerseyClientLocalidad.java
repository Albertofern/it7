...
/**
 * Jersey REST client generated for REST resource:LocalidadFacadeREST
 * [ws.localidad]<br>
 * USAGE:
 * <pre>
 *        JerseyClientLocalidad client = new JerseyClientLocalidad();
 ...
 */
public class JerseyClientLocalidad {

    private WebTarget webTarget;
    private Client client;
    private static final String BASE_URI = "http://localhost:8080/WebService/webresources";

    public JerseyClientLocalidad() {
        client = javax.ws.rs.client.ClientBuilder.newClient();
        webTarget = client.target(BASE_URI).path("ws.localidad");
    }
