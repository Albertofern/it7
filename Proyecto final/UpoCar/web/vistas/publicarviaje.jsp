    ...
    <div class="col-lg-12">
        <s:form action="publicarViaje">
            <div class="col-lg-4">
                ...
                Origen<s:select list="origen" name="localidadOrigen" listKey="idLocalidad" listValue="nombre" ></s:select><br/>
                Destino<s:select list="destino" name="localidadDestino" listKey="idLocalidad" listValue="nombre" ></s:select><br/>
